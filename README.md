...
|automysqlbackup_mail_address | str | UNDEFINED | mail Address to send mail to? (user@domain.com)  | 
|automysqlbackup_encrypt | bool | UNDEFINED | Do you wish to encrypt your backups using openssl?  | 
